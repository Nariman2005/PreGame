        ...
        <div class="register-form-container">
            ...
            <%
                ...
                if (registrationBean == null) {
                    ...
                    registrationBean.setUserType("gamer");
                }
            %>
            ...
            <form action="${pageContext.request.contextPath}/auth" method="post" class="register-form">
                ...
                <div class="form-group">
                    <label for="level">Gaming Level (1-10)</label>
                    <input type="number" id="level" name="level" value="<%= registrationBean.getLevel() > 0 ? registrationBean.getLevel() : "1" %>" min="1" max="10" required>
                </div>
