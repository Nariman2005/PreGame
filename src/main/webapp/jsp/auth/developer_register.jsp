...
<section class="register-section">
    <div class="container">
        <h2 class="section-title form-title">Register as a Game Developer</h2>
        ...
        <div class="register-form-container">
            ...
            <%
                ...
                if (registrationBean == null) {
                    ...
                    registrationBean.setUserType("developer");
                }
            %>
            ...
            <form action="${pageContext.request.contextPath}/auth" method="post" class="register-form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="companyName" name="companyName" value="<%= registrationBean.getCompanyName() != null ? registrationBean.getCompanyName() : "" %>" required>
                </div>
                ...
                <div class="form-footer">
                    ...
                    <p>Register as a:
                        ...
                        <a href="${pageContext.request.contextPath}/auth?action=register&type=tester">Tester</a>
                    </p>
                </div>
            </form>
        </div>
